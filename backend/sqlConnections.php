	...
	require("sqlErrorMessages.php");	
  	function executeQuery($query){
        ...
        $_SESSION['sql_debug'] = $query;
	  	$link = mysql_connect("165.227.99.16", "root","Integrateddx2017!") or die (json_encode(array('success'=>'false','error_sql'=>mysql_error(),'messageText'=>'Error de conexi&oacute;n')));
